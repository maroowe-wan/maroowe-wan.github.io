...
/* ByteByteGo 풍 (devops-basics 등 .bbg-diagrams 페이지에만 — main.js가 URL로 클래스 부여) */
.bbg-diagrams .diagram{padding:24px 22px 16px;background:#f8fafc;border:1px solid #dbe3ee;border-top:4px solid #2563eb;border-radius:14px;box-shadow:0 6px 18px rgba(16,36,62,.13)}
.bbg-diagrams .diagram figcaption{margin-top:14px;font-weight:600}
.bbg-diagrams .mermaid[data-processed='true'] .node rect,.bbg-diagrams .mermaid[data-processed='true'] .node polygon{rx:12px;ry:12px}
.bbg-diagrams .mermaid[data-processed='true'] .node rect,.bbg-diagrams .mermaid[data-processed='true'] .node circle,.bbg-diagrams .mermaid[data-processed='true'] .node polygon,.bbg-diagrams .mermaid[data-processed='true'] .node path{filter:drop-shadow(0 3px 6px rgba(16,36,62,.20))}
.bbg-diagrams .mermaid[data-processed='true'] .nodeLabel{font-weight:700}
.bbg-diagrams .mermaid[data-processed='true'] .edgePaths .path,.bbg-diagrams .mermaid[data-processed='true'] .flowchart-link{stroke-width:2.5px}
.bbg-diagrams .mermaid[data-processed='true'] .cluster rect{rx:14px;ry:14px}
.bbg-diagrams .mermaid[data-processed='true'] .cluster .nodeLabel,.bbg-diagrams .mermaid[data-processed='true'] .cluster text{font-weight:700}
.bbg-diagrams .mermaid[data-processed='true'] .actor{rx:8px;ry:8px}
.bbg-diagrams .mermaid[data-processed='true'] text.actor,.bbg-diagrams .mermaid[data-processed='true'] .actor>tspan{font-weight:700}
